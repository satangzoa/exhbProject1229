                     ...
                     <table border="0" cellspacing="0" cellpadding="10">
                        <form action="reservationOk" method="post" name="reservation_frm">
                           <tr>
                              ...
                              <td><input class="input_type01" type="text" name="mid" value="${memberDto.mid}"></td>
                           </tr>
                           <tr>
                              <td><span class="content_text01">전시회이름</span></td>
                              <td><input class="input_type01" type="text" name="ticketName" value="${Ticketing.ticketName}"></td>
                           </tr>
                              ...
                              <td><input class="input_type01" type="text" name="mid" value="${Ticketing.tprice}">
                         <select name="count">
                           ...
                           <tr>
                              <td colspan="2" align="center">
                                 ...
                                 <input class="button_type01" type="button"  value="뒤로" onclick="history.go(-1); ">
                              </td>
                           </tr>
                        </form>
                     </table>
